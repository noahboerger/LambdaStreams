...
public class Application {
    ...
    public List<Record> loadRecords() {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                records.add(new Record(id,entries[1],downTimeInMinutes,entries[3],entries[4],source, shift));
    ...
    public void executeSQL07() {
        ...
        System.out.println("\n7: " + idList);
        System.out.println("Für diese Aufgabe bitte mein Kommentar über executeSQL07 beachten\n");
    }
